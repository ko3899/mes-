...
- [x] **Step 3: Implement immutable dataclasses and exact validation**
...
- [x] **Step 4: Run GREEN test and existing machine protocol tests**
...
- [x] **Step 1: Write failing persistence and ordering tests**
...
- [x] **Step 3: Implement SQLite outbox**
...
- [x] **Step 4: Run GREEN and restart durability tests**
...
- [x] **Step 3: Add central tables and transactional ingestion**
...
- [x] **Step 4: Run GREEN and database migration tests**
...
- [x] **Step 3: Implement routes and register blueprint**
...
- [x] **Step 4: Run GREEN and app API regression tests**
...
- [x] **Step 1: Write failing AIM mapping tests**
...
- [x] **Step 3: Implement deterministic mapping without changing legacy results**
...
- [x] **Step 4: Run GREEN and full AIM suite**
...
- [x] **Step 2: Write exact setup and recovery instructions**
...
- [x] **Step 3: Verify documentation commands in a temporary directory**
