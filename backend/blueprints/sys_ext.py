...
ACTION_PERMISSION_CATALOG = [
    ...
    {'key': 'scm:read', 'label': '采购供应链-查看'},
    {'key': 'scm:write', 'label': '采购供应链-维护'},
    {'key': 'scm:receipt', 'label': '采购收料-过账'},
    ...
    {'key': 'eqp:read', 'label': '设备台账-查看'},
    {'key': 'eqp:write', 'label': '设备台账-维护'},
    {'key': 'doc:read', 'label': '文档-查看'},
    {'key': 'doc:write', 'label': '文档-维护'},
    {'key': 'aps:write', 'label': '排产-维护'},
    {'key': 'cost:write', 'label': '成本-维护'},
    {'key': 'erp:write', 'label': 'ERP同步-维护'},
    {'key': 'flow:write', 'label': '流程-维护'},
    {'key': 'flow:approve', 'label': '流程-审批'},
    {'key': 'hr:write', 'label': '人事培训-维护'},
    {'key': 'iot:write', 'label': 'IoT数据-维护'},
    {'key': 'process:write', 'label': '制程控制-维护'},
    {'key': 'quality:write', 'label': '质量管理-维护'},
    {'key': 'sched:write', 'label': '排班/日历-维护'},
    {'key': 'site:write', 'label': '现场工位/安灯-维护'},
    {'key': 'svc:write', 'label': '售后服务-维护'},
    {'key': 'tool:write', 'label': '工具/工装-维护'},
    {'key': 'util:write', 'label': '能源环境-维护'},
]
